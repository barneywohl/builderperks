...
assert.match(await readFile("netlify/functions/ad-stream.mts", "utf8"), /blockedKeywords/);
assert.match(await readFile("netlify/functions/ad-stream.mts", "utf8"), /matchesBlockedPreference/);
